			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form name="reset" class="form-horizontal" role="form" action="/teacher/markhandle" id="editfrom" method="post" onsubmit="return check()">
							...
							<div class="form-group">
							  ...
							  <div class="form-group">
							    <label for="inputPassword3" class="col-sm-2 control-label" value="${userName}">姓名</label>
							    <div class="col-sm-10">
							      <input  readonly="readonly" type="text" name="name" class="form-control" id="inputPassword3" ">
							    </div>
							  </div>
							  <div class="form-group">
