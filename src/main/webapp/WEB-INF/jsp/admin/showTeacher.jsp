				    ...
				    <div class="panel-footer">
						<c:if test="${pagebean.totalCount != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="/admin/showTeacher?page=${pagebean.pagenum-1}">&laquo;上一页</a></li>
									
									<c:if test="${pagebean.pagenum-2 > 0}">
										<li><a href="/admin/showTeacher?page=${pagebean.pagenum-2}">${pagebean.pagenum-2}</a></li>
									</c:if>
									<c:if test="${pagebean.pagenum-1 > 0}">
										<li><a href="/admin/showTeacher?page=${pagebean.pagenum-1}">${pagebean.pagenum-1}</a></li>
									</c:if>
									...
									<li><a href="/admin/showTeacher?page=${pagebean.pagenum+1}">下一页&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
