			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/admin/edit" id="editfrom" method="post">
							  ...
							  <div class="form-group">
								  ...
								  <div class="col-sm-10">
									  <select class="form-control" name="teacherid" id="teacherid">
											  <option value="${course.teacherid}">${course.userName}</option>
									  </select>
								  </div>
							  </div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="coursetype" id="coursetype">
										<option value="${course.coursetype}">${course.coursetype}</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="text" class="form-control" name="collegeid" value="${course.collegeid}" placeholder="请输入院系">
