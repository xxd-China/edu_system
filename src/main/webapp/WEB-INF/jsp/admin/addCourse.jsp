			...
			<div class="panel panel-default">
				<div class="panel-heading">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/admin/add" id="editfrom" method="post">
							  <div class="form-group">
							    <label for="inputEmail3" class="col-sm-2 control-label">课程号</label>
							    <div class="col-sm-10">
							      <input   type="text" class="form-control" id="inputEmail3" value="${course.courseid}" name="courseid" placeholder="请输入课程号">
							    </div>
							  </div>
							  <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="courseweek" value="${course.courseweek}" placeholder="请输入周数">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" name="collegeid" id="gradeid">
...
<script type="text/javascript">
  ...
  $.ajax({
   ...
   success: function(data){
       ...
       $.each(data, function (index, item) {
          ...
          var ht = $("#teacherid").html();
          $("#teacherid").html(ht + "<option value='" + id + "'>" + name + "</option>");
       });
   }
 });
  ...
  $.ajax({
   ...
   success: function(data){
       ...
       $.each(data, function (index, item) {
         //循环获取数据
          var name = data[index].collegename;
          var id = data[index].collegeid;
          var ht = $("#gradeid").html();
          $("#gradeid").html(ht + "<option value='" + id + "'>" + name + "</option>");
       });
   }
 });
