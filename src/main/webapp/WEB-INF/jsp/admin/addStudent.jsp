			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/admin/addStu" id="editfrom" method="post">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <select class="form-control" id="c" name="collegeid">
   ...
   success: function(data){
      ...
      $.each(data, function (index, item) {
         //循环获取数据
          ...
          var ht = $("#c").html();
          $("#c").html(ht + "<option value='" + id + "'>" + name + "</option>");
       });
   }
 });
	</script>
